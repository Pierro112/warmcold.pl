...
export default function Sitemap() {
  ...
  const content = {
    pl: { title: 'Mapa strony', cta: 'Skontaktuj się z nami', comingSoon: 'Strona w przygotowaniu' },
    en: { title: 'Sitemap', cta: 'Contact us', comingSoon: 'Page under construction' },
    uk: { title: 'Карта сайту', cta: "Зв'яжіться з нами", comingSoon: 'Сторінка в розробці' },
  };
