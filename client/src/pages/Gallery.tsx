...
export default function Gallery() {
  ...
  const content = {
    pl: { title: 'Galeria realizacji', cta: 'Skontaktuj się z nami', comingSoon: 'Strona w przygotowaniu' },
    en: { title: 'Project Gallery', cta: 'Contact us', comingSoon: 'Page under construction' },
    uk: { title: 'Галерея проектів', cta: "Зв'яжіться з нами", comingSoon: 'Сторінка в розробці' },
  };
