...
export default function Financing() {
  ...
  const content = {
    pl: { title: 'Finansowanie i raty', cta: 'Skontaktuj się z nami', comingSoon: 'Strona w przygotowaniu' },
    en: { title: 'Financing and Installments', cta: 'Contact us', comingSoon: 'Page under construction' },
    uk: { title: 'Фінансування та розстрочка', cta: "Зв'яжіться з нами", comingSoon: 'Сторінка в розробці' },
  };
