...
export default function Warranty() {
  ...
  const content = {
    pl: { title: 'Gwarancja i serwis', cta: 'Skontaktuj się z nami', comingSoon: 'Strona w przygotowaniu' },
    en: { title: 'Warranty and Service', cta: 'Contact us', comingSoon: 'Page under construction' },
    uk: { title: 'Гарантія та сервіс', cta: "Зв'яжіться з нами", comingSoon: 'Сторінка в розробці' },
  };
