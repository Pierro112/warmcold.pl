...
export default function Downloads() {
  ...
  const content = {
    pl: { title: 'Centrum pobierania', cta: 'Skontaktuj się z nami', comingSoon: 'Strona w przygotowaniu' },
    en: { title: 'Download Center', cta: 'Contact us', comingSoon: 'Page under construction' },
    uk: { title: 'Центр завантажень', cta: "Зв'яжіться з нами", comingSoon: 'Сторінка в розробці' },
  };
