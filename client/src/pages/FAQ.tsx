...
export default function FAQ() {
  ...
  const content = {
    pl: { title: 'Najczęściej zadawane pytania', cta: 'Skontaktuj się z nami', comingSoon: 'Strona w przygotowaniu' },
    en: { title: 'Frequently Asked Questions', cta: 'Contact us', comingSoon: 'Page under construction' },
    uk: { title: 'Часті запитання', cta: "Зв'яжіться з нами", comingSoon: 'Сторінка в розробці' },
  };
