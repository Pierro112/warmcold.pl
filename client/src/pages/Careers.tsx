...
export default function Careers() {
  ...
  const content = {
    pl: { title: 'Kariera', cta: 'Skontaktuj się z nami', comingSoon: 'Strona w przygotowaniu' },
    en: { title: 'Careers', cta: 'Contact us', comingSoon: 'Page under construction' },
    uk: { title: "Кар'єра", cta: "Зв'яжіться з нами", comingSoon: 'Сторінка в розробці' },
  };
