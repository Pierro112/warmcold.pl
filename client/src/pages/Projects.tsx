...
export default function Projects() {
  ...
  const content = {
    pl: { title: 'Nasze projekty', cta: 'Skontaktuj się z nami', comingSoon: 'Strona w przygotowaniu' },
    en: { title: 'Our Projects', cta: 'Contact us', comingSoon: 'Page under construction' },
    uk: { title: 'Наші проекти', cta: "Зв'яжіться з нами", comingSoon: 'Сторінка в розробці' },
  };
